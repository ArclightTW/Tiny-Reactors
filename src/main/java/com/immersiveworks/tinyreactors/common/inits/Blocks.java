...
public class Blocks {
	...
	public static Block REACTOR_TRANSFER_PORT = new BlockReactorTransferPort();		// Handles Energy, Block and Waste Transfer
	public static Block REACTOR_HEAT_SINK = new BlockReactorHeatSink();				// Used to Increase the Temperature Threshold
	public static Block REACTOR_AIR_VENT = new BlockReactorAirVent();				// Used to Cool the Structure
